...
public class Tracker implements AutoCloseable {
    ...
    public Tracker() throws FileNotFoundException, SQLException {
        ...
        File file = new File(classLoader.getResource("start.txt").getFile());
    ...
    public Item findById(int id) throws SQLException {
        Item item = null;
        PreparedStatement st = conn.prepareStatement(findByIdQuery);
        st.setInt(1, id);
    ...
    public ArrayList<Item> findByName(String name) throws SQLException {
        ...
        PreparedStatement st = conn.prepareStatement(findByNameQuery);
        st.setString(1, name);
        ResultSet rs = st.executeQuery();
        while (rs.next()) {
            Item item = new Item();
    ...
    public ArrayList<Item> getAll() throws SQLException {
        ArrayList<Item> finder = new ArrayList<>();
        PreparedStatement st = conn.prepareStatement(getAllQuery);
        ResultSet rs = st.executeQuery();
        while (rs.next()) {
            Item item = new Item();
            item.setId(rs.getInt(1));
